...
// Source: github.com/mortum5/simple-bank/db/sqlc (interfaces: Store)
//
...
// TranferTx mocks base method.
func (m *MockStore) TranferTx(arg0 context.Context, arg1 db.TransferTxParams) (db.TranferTxResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TranferTx", arg0, arg1)
	ret0, _ := ret[0].(db.TranferTxResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// TranferTx indicates an expected call of TranferTx.
func (mr *MockStoreMockRecorder) TranferTx(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TranferTx", reflect.TypeOf((*MockStore)(nil).TranferTx), arg0, arg1)
}
